...
const Eventcard = () => {
  return (
    <div className="event-card bg-[#DEF6EB] rounded-lg p-8 lg:p-6 m-2">
      <div class="flex items-center gap-1.5">
        <img
          class="w-9 h-9 md:w-9 md:h-9 rounded-full"
          src={userImg}
          alt="User Avatar"
        />
      ...
      <div className="mt-2 md:mt-4">
        ...
        <div className="text-zinc-700  md:text-sm font-semibold leading-normal">
      ...
      <div className="mt-2 md:mt-4">
        <div className="pt-3 flex items-center gap-2.5">
          <button className=" border-2 border-[#1F0A58] text-[#1F0A58] py-2 px-4 rounded-full text-xs md:text-sm">
            Join
          </button>
        </div>
      </div>
