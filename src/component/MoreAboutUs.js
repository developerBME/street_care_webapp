            ...
            <div className="flex gap-4 mt-4 flex-col md:flex-row items-center">
                <div className="md:w-1/2 min-[320px]:max-md:w-full min-h-full place-self-stretch min[320px]:max-flex-col gap-2 flex">
                        ...
                        <img src={pic1} alt="pic1" className="w-full shrink-0 " />
                            <div className="p-4">
                            <p className="font-open-sans lg:text-[14px] md:text-[14px] sm:text-xs ">NY Attorney General</p>
                            <p className="font-bricolage lg:text-[20px] md:text-[20px] sm:text-md mt-2">Letitia James</p>
                            </div>
                        </div>
                        ...
                        <div className="p-4">
                            <p className="font-open-sans lg:text-[14px] md:text-[14px] sm:text-sm ">NYC Mayor</p>
                            <p className="font-bricolage lg:text-[20px] md:text-[20px] sm:text-md mt-2">Eric Adams</p>
                        </div>
                        </div>
