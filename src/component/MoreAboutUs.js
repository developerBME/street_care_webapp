      ...
      <div className="flex gap-4 mt-4 flex-col md:flex-row items-center">
        <div className="md:w-1/2 min-[320px]:max-md:w-full min-h-full place-self-stretch min[320px]:max-flex-col gap-2 flex">
          <div className="bg-[#F2F6D8] w-full min-h-full rounded-[30px] flex flex-col">
            ...
            <div className="p-6">
              <p className="font-open-sans lg:text-[14px] md:text-[14px] sm:text-xs ">
                NY Attorney General
              </p>
              <p className="font-bricolage lg:text-[20px] md:text-[20px] sm:text-md mt-2">
                Letitia James
              </p>
            </div>
          </div>
          ...
          <div className="bg-[#F2F6D8] w-full min-h-full rounded-[30px] flex flex-col">
            ...
            <div className="p-6">
              <p className="font-open-sans lg:text-[14px] md:text-[14px] sm:text-sm ">
                NYC Mayor
              </p>
              <p className="font-bricolage lg:text-[20px] md:text-[20px] sm:text-md mt-2">
                Eric Adams
        ...
        <div className="md:w-1/2  flex place-self-stretch">
          <div className="bg-[#F2F6D8] w-full rounded-[30px] h-full flex flex-col justify-end pb-8">
            <div className="p-7 md:px-8">
              <p className=" font-bricolage font-medium leading-8 text-2xl md:text-[18px] self-stretch grow shrink basis-0 text-center text-neutral-800 md:leading-7 ">
            ...
            <div className=" mt-6 md:mt-9">
              <p className="text-center text-neutral-800 text-sm italic font-normal font-inter leading-normal ">
