    ...
    <div className="items-center justify-center px-4 py-8 lg:p-24 h-full w-full rounded-2xl bg-[#F7F7F7]">
      ...
      <div className="grid grid-cols-1 gap-x-8 gap-y-8 mt-6 sm:pt-4 lg:mx-0 lg:max-w-none lg:grid-cols-3">
        ...
        >
          ...
          <div className="flex flex-col h-full ml-2 mt-6 justify-end">
            <a className="text-sm font-opensans underline pb-2 cursor-pointer text-[#212121]">
              Read More →
            </a>
          </div>
        </article>
        ...
        >
          <div className=" h-full">
            ...
            <p className="mt-2 text-sm line-clamp-4 leading-6 text-[#212121] px-2 font-opensans font-normal">
              Thank You to the United Methodist church (Baltimore-Washington DC)
              for rewarding BME Maryland partners with a grant for SC
            </p>
          </div>
          <div className="flex flex-col h-full ml-2 mt-6 justify-end">
            <a className="mt-5 px-2 text-sm font-opensans underline pb-2 cursor-pointer text-[#212121]">
              Read More →
            </a>
          </div>
        </article>
