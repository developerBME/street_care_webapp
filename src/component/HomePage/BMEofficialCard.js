...
const BMEofficialCard = ({BMEcardData}) => {
  ...
  return (
      ...
      <div className=" grow shrink basis-0 bg-sky-100 rounded-3xl flex-col justify-start items-start inline-flex">
        ...
        <div className="self-stretch h-20 px-6 pt-4 mt-10 lg:mt-20 xl:mt-0  lg:py-20 xl:py-15 2xl:py-12 2xl:mt-0 flex-col justify-start items-start gap-2.5 flex">
          <div className="self-stretch justify-start items-center gap-2.5 inline-flex">
            {<CustomButton label={label} name="buttonsmallblue2" onClick = {(e) => handleRsvp(e, id, label, navigate, label2, setLabel2, true)} />}
