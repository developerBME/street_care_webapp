...
function PastOutreachEventCardSkeleton() {
  return (
    <div
      role="status"
      className="w-full p-4 my-9 border border-gray-200 rounded-xl shadow animate-pulse md:p-6 dark:border-gray-700"
    >
...
export default PastOutreachEventCardSkeleton;
