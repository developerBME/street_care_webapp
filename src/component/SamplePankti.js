  ...
  return (
    <div className="flex py-16 flex-col items-center justify-center">
      ...
      <div className="w-full justify-center flex">
        <div className="bg-[#F7F7F7] w-[61%] rounded-b-2xl px-8 py-10 flex-col justify-start items-start inline-flex">
          ...
          <div className="w-full">
            <div className="p-4 sm:p-4 lg:p-8 gap-16 bg-white border-b border-[#C8C8C8] sm:justify-end">
              <div className="flex relative">
                  <div className="flex text-center text-sm font-semibold font-opensans leading-normal">
                    <p className="rounded-lg bg-[#FEF9EF] p-2 text-[#836A00]">Help On the way</p> 
                    {/* <img className="h-25 w-25" src="data:image/png;base64,"/> */}
                  </div>
                  <div className="text-xs text-[#616161] m-2">
                    <p>Posted 30 mins ago by User K</p>
                  </div>
                  <div className="ml-auto text-sm text-[#181818]">
                    <p className="bg-[#E6DCFF] rounded-3xl p-2">Mark as help Received</p>
                  </div>
              </div>
              <div className="flex relative">
                  <div className="text-xs text-[#616161] m-2">
