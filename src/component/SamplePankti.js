...
function PanktiSample() {
 const navigate = useNavigate();
  return (
    <div className="relative justify-center py-16">
      <div className="flex py-16 flex-col items-center justify-center">
        <div className="w-full h-full bg-white md:w-95p lg:max-w-screen-lg sm:w-95p sm:max-w-screen-sm flex pt-12 justify-center">
          <div style={{height: 400}} className="w-full bg-no-repeat bg-cover bg-center bg-[url('images/community_bg2.png')]">
            {/* <div>
              Community
            </div> */}
          </div>
      ...
      <div className="flex py-16 flex-col items-center justify-center">
        <div className="w-full md:w-95p lg:max-w-screen-lg sm:w-95p sm:max-w-screen-sm flex justify-center">
