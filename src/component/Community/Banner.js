      ...
      <div className="px-[8px] py-6 lg:px-24 lg:pb-[55px] lg:pt-[25px] md:px-[25px] md:py-[25px] bg-[right_bottom_-150px] bg-no-repeat relative">
        <div className="lg:items-start md:items-center justify-center h-full w-full grid md:grid-cols-4 lg:grid-cols-5 gap-2 md:mb-[70px] mb-[33px]">
          <div className="lg:col-span-2 md:col-span-2 lg:mt-[30px]">
            <p className="font-sans font-medium lg:text-[44px] sm:text-[38px] text-[36px]">
              Community Hub
            </p>
            <p className="font-medium lg:text-[26px]">
              Join us today to make meaningful impact.
            </p>
          </div>
        ...
        <div className="bg-white rounded-3xl lg:text-[18px] md:text-[18px] text-[12px] relative z-[9]">
          <div className="flex flex-wrap h-fit">
            ...
            <div className="w-1/3 sm:w-1/3 md:w-1/3 lg:w-1/3 lg:px-[28px] lg:p-[20px] md:p-[18px] p-[18px] lg:text-left md:text-center sm:text-center text-center">
              {/* Column content */}
              <p className="font-bold text-violet-800 lg:mb-[24px] md:mb-[10px] sm:mb-[15px]">
            ...
            {/* Column 3 */}
            <div className=" h-full w-1/3 sm:w-1/3 md:w-1/3 lg:w-1/3 lg:px-[28px] lg:py-[20px] md:p-[18px] p-[18px] lg:text-left md:text-center sm:text-center text-center">
              {/* Column content */}
              <p className="font-bold text-violet-800 lg:mb-[24px] md:mb-[10px] sm:mb-[15px]">
                Total Items Shared
              </p>
