...
function Banner() {
    return(
        <div className="items-center justify-center h-full w-full rounded-2xl bg-[#F7F7F7] bg-pattern banner2 bg-[left_bottom_-100px] bg-no-repeat relative">
            ...
            <div className="p-6 lg:px-24 lg:pb-[55px] lg:pt-[25px] md:px-[25px] md:py-[25px] bg-[right_bottom_-150px] bg-no-repeat relative">
                ...
                <div className="bg-white rounded-3xl text-[18px] relative z-[9]">
                    <div className="flex flex-wrap">
                        {/* Column 1 */}
                        <div className="w-full md:w-1/3 lg:w-1/3 lg:px-[28px] lg:p-[20px] md:p-[18px] p-[18px]">
                            {/* Column content */}
                        ...
                        {/* Column 2 */}
                        <div className="w-full md:w-1/3 lg:w-1/3 lg:px-[28px] lg:py-[20px] md:p-[18px] p-[18px] middle border-y-2 border-[#F2F2F2]">
                            {/* Column content */}
                        ...
                        {/* Column 3 */}
                        <div className="w-full md:w-1/3 lg:w-1/3 lg:px-[28px] lg:py-[20px] md:p-[18px] p-[18px]">
                            {/* Column content */}
