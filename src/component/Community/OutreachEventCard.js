    ...
    return (
        <div className="bg-[#F5EEFE] w-[340px] lg:w-full rounded-2xl mb-4">
            ...
            <div className="px-5 py-2 space-y-2 w-full">
                ...
                <div className="font-normal font-['Inter'] text-[#444746] text-[12px]">{location.add1}, {location.add2}, {location.state}, {location.zipcode}</div>
                <div className="w-full inline-flex items-center bg-white px-4 py-2 space-x-2.5 rounded-2xl">
                    <img src={wavingHand} />
                    <div className="font-normal font-['Inter'] text-[12px] text-[#181818]">{helpType}</div>
                </div>
            </div>
