...
const HelpRequest = () => {
  return (
    <div>
      <div className="px-32 py-16 bg-gradient-to-br from-[#C0F4FF] to-[#DDD] rounded-t-2xl">
        <div className="flex gap-x-4 items-center">
          <div>
            <img className="w-16 h-16" src={wavingHand} alt="..."></img>
          </div>
          <div className="text-[#212121] text-4xl font-medium font-bricolage leading-[44px]">
            Help Requests
          </div>
      ...
      <div className="px-32 pb-32 pt-16 flex flex-col bg-[#F7F7F7] gap-8 rounded-b-2xl">
        <div>
          <div className="p-8 gap-16 bg-white border-y border-[#C8C8C8] justify-end">
            <div className="flex gap-x-8">
              ...
              <div className="w-[164px] h-fit flex-col justify-start items-end gap-4 inline-flex">
                <button className="w-fit bg-[#E6DCFF] hover:bg-[#6840E0] text-[#181818] hover:text-white rounded-[100px] flex-col justify-start gap-2 flex px-6 py-2.5 text-center text-[11px] font-semibold font-inter leading-tight">
                  I can help
                </button>
              </div>
            </div>
          ...
          {/*  */}
          <div className="p-8 gap-8 bg-white border-y border-[#C8C8C8]justify-end">
            <div className="flex gap-x-8 flex-start">
              <div className="w-fit h-fit flex-col justify-start items-start gap-[15px] inline-flex">
              ...
              <div className="flex-col justify-start items-end gap-2.5 inline-flex">
                <button className="bg-[#E6DCFF] hover:bg-[#6840E0] text-[#181818] hover:text-white rounded-[100px] flex-col justify-center items-center gap-2 inline-flex text-[11px] font-semibold font-inter leading-tight self-stretch px-6 py-2.5 text-center">
                  Mark as Help Recieved
                </button>
                <button className="bg-[#6840E0] hover:bg-[#E6DCFF] text-white hover:text-[#181818] rounded-[100px] flex-col justify-center items-center gap-2 inline-flex text-center text-[11px] font-semibold font-inter leading-tight self-stretch px-6 py-2.5">
                  Reopen Help Request
                </button>
              </div>
            </div>
        ...
        <button className="w-fit rounded-[100px] border border-[#C8C8C8] flex-col justify-center items-center gap-2 flex text-center text-[#1F0A58] hover:bg-[#1F0A58] hover:text-white text-[11px] font-semibold font-inter leading-tight self-stretch px-6 py-2.5">
          Load 5 More
        </button>
      </div>
    </div>
