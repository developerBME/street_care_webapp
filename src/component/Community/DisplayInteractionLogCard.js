  ...
  return (
    ...
    >
      <div className="relative group">
        ...
        />
        <div
          className="absolute right-16 top-0 bg-gray-800 text-dark text-sm rounded-md px-2 py-1 opacity-0 group-hover:opacity-100 transition-opacity duration-30 whitespace-normal"
