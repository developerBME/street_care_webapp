    ...
    return(
        ...
        <div className="items-center justify-center px-4 py-8 lg:pb-[25px] lg:px-36 h-full w-full lg:rounded-none rounded-2xl bg-[#F7F7F7] lg:m-0 mb-[10px]">
            ...
            <ul className="list-disc ml-[20px] mb-[30px] text-[#616161]">
                ...
                <li className="text-[15px]">It's best to provide new and unused personal care products for hygiene reasons.</li>
            </ul>
        ...
        <div className="items-center justify-center px-4 py-8 lg:pb-24 lg:px-36 h-full w-full lg:rounded-b-2xl lg:rounded-t-none rounded-2xl bg-[#F7F7F7] ">
            ...
            <ul className="list-disc ml-[20px] mb-[30px] text-[#616161]">
                ...
                <li className="text-[15px]">Remember to read labels for allergen information and encourage recipients to do the same. Sensitivity to dietary restrictions is essential for safe and helpful assistance. [Nuts, Gluten, Diary, Seed, Fruits (Apples, oranges, bannas, ) Protein (Beef Jerky)]</li>
            </ul>
            <div className="overflow-x-scroll">
                <div className="w-fit flex lg:flex-wrap">
