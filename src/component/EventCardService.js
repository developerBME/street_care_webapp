        ...
        onAuthStateChanged(fAuth, async (user) => {
            if (user) {
                try {
                    ...
                    const eventRef = isBMEFlow ? doc(db, OFFICIAL_EVENTS_COLLECTION, id) : doc(db, OUTREACH_EVENTS_COLLECTION, id);
                    ...
                    let currentEvents = (isBMEFlow ? userSnap.data().officialEvents : userSnap.data().outreachEvents) || [];
                    ...
                    if (currentParticipants.includes(fAuth.currentUser.uid)) {
                        ...
                        const eventDocUpdate = isBMEFlow ? doc(db, OFFICIAL_EVENTS_COLLECTION, id) : doc(db, OUTREACH_EVENTS_COLLECTION, id);
