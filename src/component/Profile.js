    ...
    <div className="bg-gradient-to-tr from-[#E4EEEA] from-10% via-[#E4EEEA] via-60% to-[#EAEEB5] to-90% bg-fixed">
      <div className="relative flex flex-col items-center ">
        ...
        <div className="  w-[95%] md:w-[90%] lg:w-[80%] mx-2 lg:mx-40 mt-8 rounded-2xl bg-white text-black mb-10">
          <div className="flex flex-col gap-14 lg:p-28 p-8">
            <div className="inline-flex flex-col sm:flex-row lg:space-x-16">
              ...
              <div className="inline-flex bg-violet-600 rounded-full gap-2 items-center p-4 mr-32">
                <img src={icon} className="w-4 h-4 mt-1"/>
                <button className="w-fit rounded-full text-neutral-100 text-[14px] ">Document my Outreach</button>
              </div>
            </div>
            <div className=" hidden sm:block">
              <div className="w-fit inline-flex bg-[#F2F6D8] p-4 rounded-xl space-x-4">
