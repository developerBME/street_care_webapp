                    ...
                    >
                      <div>
                        <label for="email">Email Address:</label><br/>
                          ...
                          className={`text-zinc-700 w-full h-12 px-6 py-2 my-1.5 border-gray-200 rounded-[6px] font-dmsans font-inter leading-snug tracking-wide ring-1 ring-inset ring-gray-200 ${
                            errormsg.EmailError !== ""
                              ? "ring-red-500"
                              : "ring-gray-300"
                          }`}
