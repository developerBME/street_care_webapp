...
const EventOutrachesSection = () => {
  ...
  const { error, metrics } = useSuccessMetrics();
  const loadMore = () => {
        ...
        <div className="flex flex-col md:flex md:flex-row justify-between gap-4 md:gap-10">
          <div className="">
            ...
            <div className="font-dmsans text-1 text-grey-300 font-normal py-2">
              ...
              homeless. Join our team of{" "}
              {`${metrics.TotalVolunteers.toLocaleString()}+`} members and
              contribute in your own way. More than{" "}
              {`${metrics.firstTimeVolunteerPercentage}%`} of our volunteers are
