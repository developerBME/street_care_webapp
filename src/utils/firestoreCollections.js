const COLLECTIONS = {
  ...
  development: {
	...
	interactionLog: process.env.REACT_APP_INTERACTION_LOG_COLLECTION_DEV || process.env.REACT_APP_INTERACTION_LOG_COLLECTION,
	helpRequestsInteractionLog: process.env.REACT_APP_HELP_REQUEST_COLLECTION_DEV || process.env.REACT_APP_HELP_REQUEST_COLLECTION,
	bmeEvents: process.env.REACT_APP_BMEEVENTS_COLLECTION,
	helpRequests: process.env.REACT_APP_HELP_REQUESTS_COLLECTION,
	contacts: process.env.REACT_APP_CONTACTS_COLLECTION,
	testUser: process.env.REACT_APP_TEST_USER_COLLECTION,
